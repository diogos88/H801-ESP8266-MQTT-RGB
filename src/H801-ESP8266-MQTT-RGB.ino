...
char* mqtt_command_topic = "HA/LEDController001/";
char* mqtt_status_topic = "HA/LEDController001/Status/";
...
void callback(char* topic, byte* payload, unsigned int length) {
   ...
   else if ((String(topic).indexOf("/w1/") != -1))
   {
   ...
   else if ((String(topic).indexOf("/w2/") != -1))
   {
...
void reconnect() {
   ...
   while (!client.connected()) {
      ...
      if (client.connect("ESP8266Client", mqtt_user, mqtt_password)) {
         ...
         // ... and resubscribe
         client.subscribe(strcat(mqtt_command_topic, "/rgb/"));
         client.subscribe(strcat(mqtt_command_topic, "/w1/"));
         client.subscribe(strcat(mqtt_command_topic, "/w2/"));
      }
      else {
